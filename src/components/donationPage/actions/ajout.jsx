        ...
        <Box>
            ...
            >
                <Box bgcolor="white" p={3} borderRadius={5}>
                    <Box sx={{ display: "flex" }}>
                        <CancelOutlined onClick={toggleAjoutDonationHandler} sx={{ marginRight: "40%" }} />
                        <Typography variant="h6" color="gray" textAlign="center">ajout Donation</Typography>
                    </Box>
                    <List>
                        <form onSubmit={togglerHandler}>
                            <ListItem sx={{ display: "flex", margin: 2, justifyContent: "center" }}>
                                <FormControl variant="standard" sx={{ minWidth: 100, justifyContent: "center" }}>
                            ...
                            <ListItem sx={{ display: "flex", margin: 2 }}>
                                ...
                                <FormControl variant="standard" sx={{ minWidth: 200 }}>
                                    <ListItem sx={{ display: "flex" }}>
                                        <InputLabel >Adress: <b><u>{adresse}</u></b></InputLabel>
                            ...
                            <ListItem sx={{ display: "flex" }}>
                                <FormControl variant="standard" sx={{ minWidth: 100 }}>
                                    <ListItem sx={{ display: "flex" }}>
                                        ...
                                        <Input value={typeIdentity} onChange={handleTypeIdentity} placeholder="type Identity..." required />
                                ...
                                <FormControl variant="standard" sx={{ minWidth: 100 }}>
                                    <ListItem sx={{ display: "flex" }} >
                                        ...
                                        <Input value={NumIdentity} onChange={handleNumIdentity} placeholder="Numero Identity..." required />
                            ...
                            <ListItem sx={{ display: "flex" }}>
                                ...
                                <FormControl variant="standard" sx={{ minWidth: 100 }}>
                                    <ListItem sx={{ display: "flex" }}>
                                        ...
                                        <Input value={Age} onChange={handleAge} placeholder="Age..." />
